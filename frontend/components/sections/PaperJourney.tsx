 ...
 * A tall (480vh) section pins a viewport-height stage while scroll progress
...
export function PaperJourney() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      if (travelRef.current) travelRef.current.style.transform = `translateY(${p * 46 * 26}px)`;
      ...
      stageRefs.current.forEach((el, i) => {
        ...
        el.style.opacity = active ? "1" : "0.26";
  ...
  return (
    <section ref={sectionRef} aria-label="The paper journey" className="relative h-[480vh] bg-ink text-paper">
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="shell grid h-full grid-cols-1 items-center gap-12 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1fr)]">
          {/* Stage list */}
            ...
            <div className="flex flex-col gap-3.5">
              {STAGES.map((stage, i) => (
                <div
                  ...
                  className="grid grid-cols-[56px_minmax(0,1fr)] gap-5 opacity-[0.28] transition-opacity duration-[380ms] ease-in-out"
                >
                  ...
                  <div>
                    ...
                    <p
                      ...
                      style={{
                        marginTop: "8px",
                        transition: "opacity 320ms ease, max-height 380ms ease, margin-top 380ms ease",
                      }}
                    >
                      {stage.en}
                      <br />
          ...
          <div className="relative hidden h-full items-center justify-center lg:flex">
            <div className="relative h-[78vh] w-full max-w-[520px]">
              {/* Travelling paper web */}
              <div className="absolute inset-y-0 left-1/2 w-[168px] -translate-x-1/2 overflow-hidden bg-paper shadow-[0_0_60px_rgba(0,0,0,0.35)]">
                <div
                  ref={travelRef}
                  className="absolute inset-x-0 top-[-200%] h-[400%]"
                  style={{
                    backgroundImage:
                      "repeating-linear-gradient(180deg, rgba(12,27,20,0.055) 0 1px, transparent 1px 46px)",
                  }}
                />
              ...
              >
                <g stroke="#1E9445" strokeWidth="1.5" fill="none">
                  ...
                  <path d="M156 150 C 156 90, 200 60, 260 60" stroke="rgba(251,250,247,0.7)" strokeWidth="2" />
                </g>
                <text x="260" y="330" textAnchor="middle" fill="#1E9445" className={STATION_LABEL} letterSpacing="2">
                  TENSION CONTROLLED
                </text>
              </svg>
              ...
              >
                ...
                <text x="260" y="430" textAnchor="middle" fill="#1E9445" className={STATION_LABEL} letterSpacing="2">
                  EMBOSS · PLY · PRINT
                </text>
              </svg>
              ...
              >
                ...
                <g stroke="#1E9445" strokeWidth="1.5" fill="none">
                  ...
                  <line x1="176" y1="330" x2="344" y2="330" strokeDasharray="4 6" stroke="rgba(12,27,20,0.35)" />
                  <line x1="176" y1="376" x2="344" y2="376" strokeDasharray="4 6" stroke="rgba(12,27,20,0.35)" />
                </g>
                <text x="260" y="466" textAnchor="middle" fill="#1E9445" className={STATION_LABEL} letterSpacing="2">
              ...
              >
                <g stroke="#1E9445" strokeWidth="1.5" fill="none">
                  <rect x="176" y="196" width="168" height="128" stroke="rgba(251,250,247,0.75)" />
                  <line x1="176" y1="240" x2="344" y2="240" stroke="rgba(251,250,247,0.35)" />
                  <line x1="260" y1="196" x2="260" y2="324" stroke="rgba(251,250,247,0.35)" />
                ...
                <text x="260" y="426" textAnchor="middle" fill="#1E9445" className={STATION_LABEL} letterSpacing="2">
                  WRAP · CARTON · LABEL
                </text>
              </svg>
              ...
              >
                ...
                <text x="260" y="280" textAnchor="middle" fill="#FBFAF7" className="font-mono text-[11px]" letterSpacing="2">
                  YOUR BRAND
                </text>
                <text x="260" y="392" textAnchor="middle" fill="#1E9445" className={STATION_LABEL} letterSpacing="2">
                  TO YOUR SPECIFICATION
                </text>
              </svg>

              {/* Progress rail */}
              <div className="absolute inset-y-[18%] right-0 w-px bg-white/[0.14]">
                <div
                  ref={railRef}
